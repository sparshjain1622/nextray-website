...
export const footerSocial = [
  { icon: "linkedin", href: "https://www.linkedin.com/company/nextray-technologies", label: "LinkedIn" },
  { icon: "facebook", href: "https://www.facebook.com/nextraytech", label: "Facebook" },
  { icon: "instagram", href: "https://www.instagram.com/nextraytech", label: "Instagram" },
  { icon: "youtube", href: "https://www.youtube.com/@nextraytech", label: "YouTube" },
] as const;
