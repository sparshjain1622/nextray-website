...
import { twentyFiveWattStreetLight } from "@/lib/products-data";

interface PageProps {
  params: Promise<{ slug: string }>;
}

const CATEGORY_HREF = "/products/outdoor";
...
export default async function OutdoorProductPage({ params }: PageProps) {
  const { slug } = await params;
      ...
      <>
        ...
        <main className="mx-auto max-w-7xl px-4 py-10 lg:px-6 lg:py-14">
          <div className="grid gap-8 lg:grid-cols-[240px_1fr] lg:gap-10">
            <ProductPremiumSidebar product={twentyFiveWattStreetLight} />
